...
Work hierarchy is **Project → Task** with task-level dependencies, gates, tags, and milestones — see [adr/ADR-0002-flatten-task-hierarchy.md](./adr/ADR-0002-flatten-task-hierarchy.md) and [TASK-MODEL.md](./TASK-MODEL.md).
