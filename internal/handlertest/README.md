...
**Whitebox tests** (unexported symbols, `decodeJSON`, path helpers) stay next to the code under `pkgs/tasks/handler`. See [`docs/contributing.md`](../../docs/contributing.md#splitting-pkgstaskshandler).
