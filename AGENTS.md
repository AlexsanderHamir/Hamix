...
| Resume quality scorecard | `cmd/resumequality/`, `scripts/resume-quality.ps1` | Live validation after feature land; `T2A_TEST_RESUME_QUALITY=1`. Runbook: [resume-quality-runbook.md](docs/domain/resume-quality-runbook.md). |
